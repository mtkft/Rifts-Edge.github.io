# Basic Info
Character Name: Zeveon "Whiff" Whithurst

Alias:
- Whiff (first by Aziz Monti, then by others)
- Potshot Hotshot (by Aziz Monti)
- Quarterling (by Aziz Monti)
- Patron God of Headshots (by Noreen Blauser)
- Silent But Deadly (Auset Sheffield)
- Corporal Whithurst
...
Affiliations: 
- Whithurst Guns
- Rift's Edge Adventurers' Guild
- Pavek Military (Formerly)
...
- Competitive Shooter
- Gunsmith
- Adventurer (occasionally)

Titles:
- Corporal
- Ballistic Arms Specialist

Notable Achievements:
- Military service 
- Competitive shooting achievements
...
Family: 
- Jairo Whithurst (Father)
- Colyn Whithurst (Grandfather)
